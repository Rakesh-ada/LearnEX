...
export default function UploadMaterialForm() {
  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-black/50 p-6 backdrop-blur-sm">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    A clear title for your study material
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Describe what students will learn from this material
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The category that best describes your material
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
